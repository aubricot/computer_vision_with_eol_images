...
df = pd.read_csv('lepidoptera_det_crops_20000.tsv', sep='\t', header=0)
print(df.head())
...
df = pd.read_csv('images_for_Lepidoptera_20K_breakdown_000001.txt', sep='\t', header=0)
...
crops.to_csv('lepidoptera_crops_rcnn_20000img_display_test.tsv', sep='\t', index=True)
...
eol_crops.to_csv('lepidoptera_crops_rcnn_20000img.tsv', sep='\t', index=False)
