...
df = pd.read_csv('data_files/input/Chiroptera/chiroptera_det_crops_20000.tsv', sep='\t', header=0)
print(df.head())
...
df = pd.read_csv('data_files/input/Chiroptera/images_for_Chiroptera_20K_breakdown_000001.txt', sep='\t', header=0)
...
crops.to_csv('data_files/output/Chiroptera/chiroptera_crops_rcnn_20000img_display_test.tsv', sep='\t', index=True)
...
eol_crops.to_csv('data_files/output/Chiroptera/chiroptera_crops_rcnn_20000img.tsv', sep='\t', index=False)
